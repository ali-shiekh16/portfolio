...
![How HTTP/1.1, HTTP/2, and HTTP/3 solve head-of-line blocking](/images/blog/how-the-web-talks/head-of-line.png)
...
![The evolution of HTTP from one connection per request to QUIC over UDP](/images/blog/how-the-web-talks/evolution-of-http.png)
---
...
![Anatomy of an HTTP request and response, including request lines, status lines, headers, and bodies](/images/blog/how-the-web-talks/anatomy-of-http-message.png)
